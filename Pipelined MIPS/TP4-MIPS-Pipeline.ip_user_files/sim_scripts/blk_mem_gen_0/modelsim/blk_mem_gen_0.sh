...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Nico/Documents/Facultad/Arquitectura/TP4 - MIPS - Final/MIPS-architecture-processor/Pipelined MIPS/TP4-MIPS-Pipeline.cache/compile_simlib/modelsim"
  fi
